...
@Autonomous(name = "Red 12", group = "Red")
@Configurable // Panels
public class Red12 extends OpMode {
    private TelemetryManager panelsTelemetry; // Panels Telemetry instance
    public Follower follower; // Pedro Pathing follower instance
    private Timer pathTimer, actionTimer, opmodeTimer, flywheelTimer; //Create timers
    ...
    static  double Flywheel_Power = 0.48;
    double currentRPM = 0;
    ...
    private final Pose start = new Pose(144-25, 127.5, Math.toRadians(180-140));
    private final Pose shootPose = new Pose(144-42-3, 116-2, Math.toRadians(180-144+8));
    private final Pose pickup1start = new Pose(144-50, 86, Math.toRadians(180-0));
    private final Pose pickup1end = new Pose(144-19, 86, Math.toRadians(180-0));
    private final Pose pickup2start = new Pose(144-50, 62, Math.toRadians(180-0));
    private final Pose pickup2end = new Pose(144-18, 62, Math.toRadians(180-0));
    //private final Pose gate = new Pose();
    private final Pose pickup3start = new Pose(144-47, 40, Math.toRadians(180-0));
    private final Pose pickup3end = new Pose(144-12, 40, Math.toRadians(180-0)); //x = 12 to go further back
    private final Pose endPose = new Pose(144-45, 120, Math.toRadians(180-144));
            ...
            */
            ...
            case 2: //grab balls at pickup 1
                ...
                if(!follower.isBusy()) {
                    ...
                    follower.followPath(paths.Pickup1, .4, false); //Hold end: False removes the small delay from the end of this path
                    setPathState(3);
                }
                break;
            case 3:
